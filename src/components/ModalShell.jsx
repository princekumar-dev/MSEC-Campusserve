...
function ModalShell({ children, panelClassName = 'max-w-lg' }) {
  ...
  return ReactDOM.createPortal(
    <div className="fixed inset-0 z-[100] flex items-center justify-center overflow-y-auto bg-slate-950/55 p-4 backdrop-blur-md sm:p-6">
      <div
        role="dialog"
        aria-modal="true"
      ...
      >
        <div
          className="premium-modal-scroll max-h-[calc(100dvh-2rem)] space-y-6 overflow-x-hidden overflow-y-auto p-5 sm:p-8"
